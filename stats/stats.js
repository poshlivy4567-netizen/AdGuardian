...
function render(data) {
  ...
  $("rules").textContent = number(data.totalRules || data.staticRules || data.filterRules);
...
function load() {
  chrome.storage.local.get({ blockedTotal: 0, blockedByDomain: {}, lastBlocked: [], filterRules: 0, staticRules: 0, totalRules: 0, filterUpdatedAt: 0, allowlist: [] }, render);
}
